...
//Search found
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Prefijo'), '014', FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Madre'), '65361881', FailureHandling.STOP_ON_FAILURE)
