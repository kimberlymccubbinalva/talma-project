...
//Search found
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Prefijo'), '663', FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Madre'), '00114796', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Hija'), '066300114796', FailureHandling.STOP_ON_FAILURE)
