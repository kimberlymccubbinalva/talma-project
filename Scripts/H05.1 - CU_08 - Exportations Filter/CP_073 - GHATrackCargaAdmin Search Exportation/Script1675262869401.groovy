...
//Search found
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Prefijo'), '174', FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Madre'), '00289413', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Hija'), '017400289413', FailureHandling.STOP_ON_FAILURE)
