...
//Search found
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Prefijo'), '045', FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Madre'), '49674192', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Hija'), '004549674192', FailureHandling.STOP_ON_FAILURE)
