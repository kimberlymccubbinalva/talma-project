...
//Search found
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Prefijo'), '272', FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Madre'), '72540134', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Module Exportaciones/Filters/Input - Nro Guía Hija'), '000420320502', FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Module Exportaciones/Filters/Option - Estado En almacén'), FailureHandling.STOP_ON_FAILURE)
