...
//Logout
WebUI.waitForElementVisible(findTestObject('Object Repository/Customer Dashboard/Identifier - BO'), 30)

WebUI.click(findTestObject('Object Repository/Customer Dashboard/Identifier - BO'))
