...
//Delete active user (non backoffice).
//Can delete admin users for any other rol (agente, aerolínea, gha, etc)
//Cannot delete another backoffice
//Deleted user no longer shows "delete" option
