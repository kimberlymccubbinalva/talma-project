...
WebUI.verifyElementPresent(findTestObject('Module Usuarios/Filters/Filter - Rol BackOffice'), 2)

WebUI.verifyElementPresent(findTestObject('Module Usuarios/Filters/Filter - Perfil BackOffice'), 2)
