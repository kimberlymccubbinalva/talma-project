...
//Avatar 2 letters
//Start of validation
WebUI.verifyElementPresent(findTestObject('Object Repository/Customer Dashboard/Identifier - GT (gha track admin)'), 2)

WebUI.click(findTestObject('Object Repository/Customer Dashboard/Identifier - GT (gha track admin)'))
