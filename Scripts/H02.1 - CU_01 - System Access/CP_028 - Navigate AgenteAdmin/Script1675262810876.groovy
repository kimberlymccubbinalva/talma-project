...
WebUI.verifyElementNotPresent(findTestObject('Module Usuarios/Create Users Form/Form Step 2/Input - Código Aerolínea'), 
    2)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Customer Dashboard/Identifier - AA (Agente Admin)'), 3)

WebUI.click(findTestObject('Object Repository/Customer Dashboard/Identifier - AA (Agente Admin)'))
