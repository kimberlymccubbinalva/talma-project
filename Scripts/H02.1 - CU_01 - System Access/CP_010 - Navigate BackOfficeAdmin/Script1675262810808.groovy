...
/*
//Module Importations
WebUI.click(findTestObject('Module Importaciones/Icon - Importaciones'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Module Importaciones/Module - Avance de Vuelos Importaciones'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Module Importaciones/Icon - Importaciones'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Module Importaciones/Module - Track de Carga Importaciones'), FailureHandling.OPTIONAL)
*/
...
//Start of validation
WebUI.verifyElementPresent(findTestObject('Customer Dashboard/Identifier - BO'), 2)
