...
//Avatar 2 letters
//Start of validation
WebUI.verifyElementPresent(findTestObject('Customer Dashboard/Identifier - AA (Aerolinea Admin)'), 2)

WebUI.click(findTestObject('Customer Dashboard/Identifier - AA (Aerolinea Admin)'))
