...
WebUI.callTestCase(findTestCase('Calls/Call - Login Passes'), [('Email') : GlobalVariable.Usr_GHA_Admin], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Module Usuarios/Create Users Form/Form Step 2/Blocked - Rol clients'), 2)
...
WebUI.verifyElementPresent(findTestObject('Module Usuarios/Create Users Form/Form Step 2/Input - Process clients'), 2)
...
//Avatar 2 letters
//Start of validation
WebUI.verifyElementPresent(findTestObject('Object Repository/Customer Dashboard/Identifier - GA (GHA Admin)'), 2)

WebUI.click(findTestObject('Object Repository/Customer Dashboard/Identifier - GA (GHA Admin)'))
