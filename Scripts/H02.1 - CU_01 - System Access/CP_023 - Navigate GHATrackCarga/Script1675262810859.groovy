...
//Avatar 2 letters
//Start of validation
WebUI.verifyElementPresent(findTestObject('Customer Dashboard/Identifier - GT (GHA Track)'), 2)

WebUI.click(findTestObject('Customer Dashboard/Identifier - GT (GHA Track)'))
