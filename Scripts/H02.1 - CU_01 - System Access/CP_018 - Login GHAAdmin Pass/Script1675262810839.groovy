...
WebUI.waitForElementVisible(findTestObject('Customer Dashboard/Identifier - GA (GHA Admin)'), 5)

WebUI.click(findTestObject('Customer Dashboard/Identifier - GA (GHA Admin)'))
