...
WebUI.callTestCase(findTestCase('Calls/Call - Login Passes'), 
	[('Email') : GlobalVariable.Usr_BackOffice_TrackCarga], FailureHandling.STOP_ON_FAILURE)

//Interacting with logout option
WebUI.waitForElementVisible(findTestObject('Customer Dashboard/Identifier - BC'), 5)
