...
WebUI.click(findTestObject('Object Repository/Login Page/Forgot Password/Button - Reenviar Código'))
...
//Verifying more than 1 coda was sent
WebUI.verifyElementPresent(findTestObject('Login Page/Forgot Password/Label - Email Código de Verificación'), 5)

WebUI.verifyElementPresent(findTestObject('Object Repository/Login Page/Forgot Password/Label - Email Código de Verificación 2'), 
    5)

//Getting the 2nd code
WebUI.click(findTestObject('Object Repository/Login Page/Forgot Password/Label - Email Código de Verificación'))

CódigoVerificación = WebUI.getText(findTestObject('Login Page/Forgot Password/Label - Código Verificación Recibido'))
