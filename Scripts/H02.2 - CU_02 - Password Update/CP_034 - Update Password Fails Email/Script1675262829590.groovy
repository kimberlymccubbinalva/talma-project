...
WebUI.setText(findTestObject('Login Page/Forgot Password/Input - Ingresa Correo'), 'fake@mail.com')

WebUI.click(findTestObject('Object Repository/Login Page/Forgot Password/Button - Enviar Código'))

WebUI.verifyElementPresent(findTestObject('Login Page/Forgot Password/Label - Wrong Email'), 5)
