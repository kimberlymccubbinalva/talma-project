...
//WebUI.click(findTestObject('Object Repository/Login Page/Forgot Password/Icon - Back To Login'))
//WebUI.click(findTestObject('Object Repository/Login Page/Label - Forgot Password'))
...
/*
 if(WebUI.setText(findTestObject('Object Repository/Login Page/Forgot Password/Outlook - Email'), Email)) {
	 WebUI.setText(findTestObject('Object Repository/Login Page/Forgot Password/Outlook - Email'), Email, FailureHandling.OPTIONAL)
	 
	 WebUI.click(findTestObject('Object Repository/Login Page/Forgot Password/Outlook - Button Next'), FailureHandling.OPTIONAL)
	 
	 WebUI.setText(findTestObject('Object Repository/Login Page/Forgot Password/Outlook - Password'), 'Netze5-syfxaf-vecgir', FailureHandling.OPTIONAL)
	 
	 WebUI.click(findTestObject('Object Repository/Login Page/Forgot Password/Outlook - Button Login'), FailureHandling.OPTIONAL)
	 
	 WebUI.click(findTestObject('Object Repository/Login Page/Forgot Password/Outlook - Login Si'), FailureHandling.OPTIONAL)
 }
 */
...
WebUI.setText(findTestObject('Login Page/Field - Email'), Email)

WebUI.setText(findTestObject('Login Page/Field - Password'), NewPassword)
