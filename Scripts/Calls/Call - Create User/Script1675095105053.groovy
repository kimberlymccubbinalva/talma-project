...
WebUI.callTestCase(findTestCase('Test Cases/Calls/Call - Login Passes'), [('Email') : GlobalVariable.Usr_BackOffice_Admin], FailureHandling.STOP_ON_FAILURE)
...
//Step_2
WebUI.setText(findTestObject('Object Repository/Module Usuarios/Create Users Form/Form Step 2/Input - Nombres Apellidos'), 'Anne Thurner')
...
WebUI.setText(findTestObject('Object Repository/Module Usuarios/Create Users Form/Form Step 2/Input - Nro Documento'), '21341234')

WebUI.setText(findTestObject('Object Repository/Module Usuarios/Create Users Form/Form Step 2/Input - Correo'), 'fake3@mail.com')

WebUI.setText(findTestObject('Object Repository/Module Usuarios/Create Users Form/Form Step 2/Input - Celular'), '999999999')

WebUI.setText(findTestObject('Object Repository/Module Usuarios/Create Users Form/Form Step 2/Input - Cargo'), 'test')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Module Usuarios/Create Users Form/Form Step 2/Button - Guardar Usuario'), 2)
